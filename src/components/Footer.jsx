...
const Footer = () => {
  return (
    <>
	<footer className="py-6 bg-light dark:text-gray-50">
	<div className="container px-6 mx-auto space-y-6 divide-y divide-gray-400 md:space-y-12 divide-opacity-50">
		<div className="grid grid-cols-12">
            ...
            />
					...
					<span className="self-center text-2xl font-semibold text-dark ">Booking</span>
				</a>
			</div>
			<div className="col-span-6 text-center md:text-left md:col-span-3">
				...
				<ul>
					<li>
						<a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-400 text-decoration-none">Link</a>
					</li>
					<li>
						<a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-400 text-decoration-none">Link</a>
					</li>
